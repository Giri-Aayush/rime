...
zcash-sign generate --network "$RIME_NET" --ak "$AK" | tee "$RIME_RUNTIME/treasury_keys.$RIME_NET.txt"
echo
echo "==> saved to $RIME_RUNTIME/treasury_keys.$RIME_NET.txt (gitignored)"
